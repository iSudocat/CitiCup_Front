        ...
        <b-card class="box" shadow>
          <div class="select-area" v-if="showSelectArea">
            <div>
              ...
              <b-form-group>
                <b-form-radio-group id="radio-group-business" v-model="business.selected" :options="business.options"
                                    buttons
            ...
            <div v-if="this.business.selected !== 1 && this.business.selected !== 0">
          ...
          <div class="Result-area" v-if="showResultArea">
            ...
            <div class="row align-items-center" style="margin-top: 50px;margin-bottom: 20px;" v-if="showIncome">
              <div class="col-4 offset-2">
            ...
            <div class="row" style="margin-top: 50px;margin-bottom: 30px;">
              <b-button block pill @click="goBack" variant="outline-primary" style="margin-top: 20px">返回</b-button>
            </div>
          </div>
...
<script>
import futureComponent from "@/pages/select/business/future"
import headerComponent from "@/pages/header/header"
import cateringComponent from "@/pages/select/business/catering";

export default {
  name: 'selectComponent',
  components: {cateringComponent, headerComponent, futureComponent},
  beforeMount() {
  ...
  methods: {
    ...
    submit: function () {
      let restUseTime = this.cookies.get('restUseTime')
      if (restUseTime <= 0) {
        alert("当前账号已过期，点击跳转到充值界面。")
