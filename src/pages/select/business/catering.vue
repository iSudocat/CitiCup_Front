<template>
  <div>
    ...
    <div class="row">
      <div class="col-6">
        <b-form-select v-model="province.selected" :options="province.options" size="sm"
                       @input="pChange"></b-form-select>
      </div>
      <div class="col-6">
    ...
    <b-form-input v-model="star" type="range" min="0" max="5" step="0.1" size="sm"
                  @input="dataTransport"></b-form-input>
    ...
    <b-form-group>
      <b-form-radio-group id="radio-group-business" v-model="shareHolding.selected" :options="shareHolding.options"
                          ...
                          @input="dataTransport"></b-form-radio-group>
    </b-form-group>
    ...
    <b-form-checkbox v-model="inputIncome" :value=true :unchecked-value=false>手动输入年收入（元） *若不输入将使用系统模型进行预测
    </b-form-checkbox>
    <b-form-input v-if="inputIncome" v-model="income" type="number" min="0" size="sm" @input="dataTransport"
